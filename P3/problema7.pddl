(define (problem ejercicio7)
	...
	(:init
		...
		; ## NUEVO ##
		; El tiempo transcurrido en primera instancia es 0
		(= (tiempoTrascurrido) 0)

		; Tiempo de la acción recolectar
		(= (tiempoRecolectar) 10)

		; Distancia entre 2 localizaciones
		(= (distanciaLocalizaciones) 10)

		; Velocidades de cada tipo de unidad en relacón unidad_distancia/unidad_tiempo
		; para obtener el tiempo luego dividiremos la distancia entre la velocidad
		(= (velocidad VCE) 1)
		(= (velocidad Marine) 5)
		(= (velocidad Segador) 10)

		; El tiempo necesario para realizar cada tarea son los siguientes
	...
	; Inlcuimos una métrica para que minimice el tiempo del plan usando minimize
