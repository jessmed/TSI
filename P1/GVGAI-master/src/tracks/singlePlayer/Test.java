...
public class Test {
    ...
    public static void main(String[] args) {
		...
		// Controlador creado por nosotros referenciando a la ruta de nuestro Agent
		String controlador = "src_Medina_Taboada_Jesus.Agent";
		...
		int gameIdx = 11;  //15-11
		int levelIdx =11; // level names from 0 to 4 (game_lvlN.txt).
		String gameName = games[gameIdx][1];
		String game = games[gameIdx][0];
		String level1 = game.replace(gameName, gameName + "Reduced_lvl" + levelIdx);
